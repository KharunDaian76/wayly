...
export const AdminAuditLogAction = {
  ...
  ORDER_MANUAL_REVIEW_MARKED: 'ORDER_MANUAL_REVIEW_MARKED',
  ORDER_MANUAL_REVIEW_CLEARED: 'ORDER_MANUAL_REVIEW_CLEARED',
  ORDER_DECISION_RECORDED: 'ORDER_DECISION_RECORDED',
  ORDER_RISK_FLAGGED: 'ORDER_RISK_FLAGGED',
  ORDER_RISK_CLEARED: 'ORDER_RISK_CLEARED',
} as const;
